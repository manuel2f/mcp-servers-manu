...
async function getAvailableComponents(version) {
    const now = Date.now();
...
async function searchInComponent(component, query, version) {
...
async function getDocContent(component, path, version) {
